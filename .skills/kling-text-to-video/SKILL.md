...
| Property | Value |
|----------|-------|
| Submit Endpoint | `POST https://app-ct7owbh7dq0x-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video` |
| Query Endpoint | `GET https://app-ct7owbh7dq0x-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/{id}` |
